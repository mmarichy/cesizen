...
export function CreateUserModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-950/45 px-4 py-6 backdrop-blur-xs">
      <div className="w-full max-w-2xl rounded-3xl border border-gray-200 bg-white p-6 shadow-[0_20px_60px_rgba(15,23,42,0.18)]">
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-orange-50 text-orange-500">
              <UserPlus size={24} />
            </div>
            <div>
              <h3 className="text-xl font-bold text-gray-900">Ajouter un utilisateur</h3>
              <p className="mt-2 text-sm text-gray-600">
                Créez un nouveau compte administrateur ou utilisateur depuis le back-office.
              </p>
            </div>
          </div>
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            disabled={isCreatingUser}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-linear-to-r from-amber-400 to-orange-500 px-4 py-3 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(249,115,22,0.3)] transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-70"
          >
            <UserPlus size={16} />
