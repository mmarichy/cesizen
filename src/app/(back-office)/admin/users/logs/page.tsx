...
function actionLabel(action: "USER_CREATED" | "USER_STATUS_CHANGED" | "USER_DELETED") {
...
function actionBadgeClassName(action: "USER_CREATED" | "USER_STATUS_CHANGED" | "USER_DELETED") {
  if (action === "USER_CREATED") {
